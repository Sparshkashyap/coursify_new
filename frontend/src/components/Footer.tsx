        ...
        <div className="mb-10 rounded-[28px] border bg-card/80 p-6 shadow-sm backdrop-blur sm:p-8">
          <div className="grid gap-8 lg:grid-cols-[1.3fr_0.8fr_0.8fr_1fr]">
            ...
            <div className="space-y-5">
              <Link
                to="/"
                className="inline-flex items-center gap-3 font-display text-xl font-bold text-primary"
              >
            ...
            {/* Support */}
            <div>
              <h4 className="mb-4 text-sm font-semibold uppercase tracking-wide text-foreground/90 ml-6">
                Support
              </h4>
              <ul className="space-y-3 text-sm text-muted-foreground">
